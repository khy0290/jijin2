...
def train_random_forest_model(df):
    ...
    # 쓰나미 예측에 사용될 입력 변수
    FEATURES = ['magnitude', 'depth', 'latitude', 'longitude', 'distance_to_coast']
...
uploaded_file = st.file_uploader(
    "다음 열을 포함하는 CSV 파일을 업로드하세요: magnitude, depth, latitude, longitude, distance_to_coast, **tsunami (0 또는 1)**", 
    type="csv"
)
